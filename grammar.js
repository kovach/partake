...
let ParserRules = [
    ...
    {"name": "episode_expr$string$7", "symbols": [{"literal":":"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": [{"literal":"~"}, "identifier", "_", "episode_expr$string$7", "_", "term"], "postprocess": (d) => [{ tag: "deictic", id: d[1], value: d[5] }]},
