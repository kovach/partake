...
let ParserRules = [
    ...
    {"name": "relation$ebnf$3", "symbols": []},
    {"name": "relation$ebnf$3$subexpression$1", "symbols": ["__", "term"]},
    {"name": "relation$ebnf$3", "symbols": ["relation$ebnf$3", "relation$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "relation", "symbols": [{"literal":"@"}, "predicate", "relation$ebnf$3"], "postprocess": (d) => ({tag: "@"+d[1], terms: d[2].map(t => t[1]).concat([{tag: 'int', value: 1}])})},
    ...
    {"name": "episode_expr", "symbols": [{"literal":"-"}, "_", "pure_query"], "postprocess": (d) => [{tag: "retract", query: d[2] }]},
    {"name": "episode_expr", "symbols": [{"literal":"+"}, "relation"], "postprocess": (d) => [{tag: "assert", tuple: d[1] }]},
    {"name": "episode_expr$string$2", "symbols": [{"literal":"c"}, {"literal":"h"}, {"literal":"o"}, {"literal":"o"}, {"literal":"s"}, {"literal":"e"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": ["term", "__", "episode_expr$string$2", "__", "quantifier", "__", "op", "pure_query", "cp"], "postprocess":  (d) => [{ tag: "subquery", query: d[7], name: '?'},
    ...
    {"name": "episode_expr$string$4", "symbols": [{"literal":"c"}, {"literal":"o"}, {"literal":"u"}, {"literal":"n"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": ["identifier", "_", "episode_expr$string$3", "_", "episode_expr$string$4", "_", "op", "pure_query", "cp"], "postprocess":  (d) => [{ tag: "subquery", query: d[7], name: d[0] },
        { tag: "count", name: d[0] }] },
    {"name": "episode_expr", "symbols": ["term", "_", "bin_op", "_", "term"], "postprocess": (d) => [{tag: 'binOp', operator: d[2], l: d[0], r: d[4]}]},
    {"name": "episode_expr$string$5", "symbols": [{"literal":"!"}, {"literal":"d"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": ["episode_expr$string$5"], "postprocess": () => [{tag: "done"}]},
    {"name": "episode_expr$string$6", "symbols": [{"literal":"!"}, {"literal":"d"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": ["episode_expr$string$6", "__", "event_expr"], "postprocess": (d) => [{tag: "do", value: d[2]}]},
