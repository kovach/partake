...
let ParserRules = [
    ...
    {"name": "episode_expr$string$1", "symbols": [{"literal":"c"}, {"literal":"h"}, {"literal":"o"}, {"literal":"o"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": ["episode_expr$string$1", "__", "quantifier", "__", "op", "pure_query", "cp"], "postprocess": (d) => [{ tag: "choose", quantifier: d[2], value: {query: d[5]} }]},
