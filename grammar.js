...
let ParserRules = [
    ...
    {"name": "rule", "symbols": [{"literal":"!"}, "identifier", "rule_separator", "rule_body", "_", {"literal":"."}], "postprocess": (d) => ({head: d[1], type: 'before', body: d[3] })},
    {"name": "rule", "symbols": ["identifier", "rule_separator", "rule_body", "_", {"literal":"."}], "postprocess": (d) => ({head: d[0], type: 'during', body: d[2] })},
    {"name": "rule", "symbols": ["identifier", {"literal":"!"}, "rule_separator", "rule_body", "_", {"literal":"."}], "postprocess": (d) => ({head: d[0], type: 'after', body: d[3] })},
