...
let ParserRules = [
    ...
    {"name": "relation", "symbols": ["predicate", "relation$ebnf$1"], "postprocess": (d) => ({tag: d[0], terms: d[1].map(t => t[1])})},
    ...
    {"name": "relation", "symbols": ["predicate", "relation$ebnf$2", "_", "relation$string$1", "term"], "postprocess": (d) => ({tag: d[0], terms: d[1].map(t => t[1]), weight: d[4]})},
