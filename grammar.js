...
let ParserRules = [
    ...
    {"name": "ob", "symbols": [{"literal":"["}, "_"], "postprocess": () => null},
    {"name": "cb", "symbols": ["_", {"literal":"]"}], "postprocess": () => null},
    ...
    {"name": "quantifier$string$1", "symbols": [{"literal":"a"}, {"literal":"n"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "quantifier", "symbols": ["quantifier$string$1"], "postprocess": (d) => ({tag: 'any'})},
    {"name": "quantifier$string$2", "symbols": [{"literal":"a"}, {"literal":"l"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "quantifier", "symbols": ["quantifier$string$2"], "postprocess": (d) => ({tag: 'all'})},
    {"name": "quantifier$string$3", "symbols": [{"literal":"r"}, {"literal":"a"}, {"literal":"n"}, {"literal":"d"}, {"literal":"o"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "quantifier", "symbols": ["ob", "quantifier$string$3", "_", "term", "cb"], "postprocess": (d) => ({tag: 'random', count: d[3]})},
    {"name": "quantifier$string$4", "symbols": [{"literal":"u"}, {"literal":"p"}, {"literal":"t"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "quantifier", "symbols": ["ob", "quantifier$string$4", "_", "term", "cb"], "postprocess": (d) => ({tag: 'upto', count: d[3]})},
    {"name": "quantifier", "symbols": ["number"], "postprocess": (d) => ({tag: 'eq', count: {tag: 'int', value: d[0]}})},
    ...
    {"name": "term", "symbols": ["number"], "postprocess": (d) => ({tag: 'int', value: d[0]})},
    ...
    {"name": "temr", "symbols": ["quantifier"], "postprocess": id},
    {"name": "binRel", "symbols": [{"literal":"="}], "postprocess": () => '='},
    ...
    {"name": "relation", "symbols": ["term", "_", {"literal":"="}, "_", "term"], "postprocess": (d) => ({tag: '@eq', terms: [d[0], d[4], {tag: 'int', value: 1}]})},
    {"name": "relation", "symbols": ["term", "_", {"literal":"<"}, "_", "term"], "postprocess": (d) => ({tag: '@lt', terms: [d[0], d[4], {tag: 'int', value: 1}]})},
    {"name": "relation$string$2", "symbols": [{"literal":"<"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "relation", "symbols": ["term", "_", "relation$string$2", "_", "term"], "postprocess": (d) => ({tag: '@le', terms: [d[0], d[4], {tag: 'int', value: 1}]})},
    ...
    {"name": "event_expr", "symbols": ["identifier"], "postprocess": (d) => ({ tag: "literal", name: d[0], tuples: []})},
    {"name": "event_expr", "symbols": ["identifier", "_", {"literal":"["}, "_", "indexical_list", "_", {"literal":"]"}], "postprocess": (d) => ({ tag: "with-tuples", name: d[0], tuples: d[4]})},
    ...
    {"name": "episode_expr$ebnf$2", "symbols": ["episode_expr$ebnf$2", "episode_expr$ebnf$2$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "episode_expr", "symbols": ["episode_expr$string$4", "_", "quantifier", "_", {"literal":"("}, "episode_expr$ebnf$2", "cp"], "postprocess": (d) => [{ tag: "branch", quantifier: d[2], value: d[5].map((d) => d[2]) }]},
    {"name": "episode_expr", "symbols": ["op", "rule_body", "cp"], "postprocess": (d) => [{tag: "subStory", story: d[1] }]},
    {"name": "episode_expr$string$5", "symbols": [{"literal":"i"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": ["episode_expr$string$5", "_", "op", "pure_query", "cp"], "postprocess": (d) => [{ tag: "countIf", value: d[3] }]},
    {"name": "episode_expr$string$6", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "episode_expr", "symbols": ["episode_expr$string$6", "_", "op", "pure_query", "cp"], "postprocess": (d) => [{ tag: "countNot", value: d[3] }]},
    {"name": "episode_expr", "symbols": ["indexical_stmt"], "postprocess": (d) => [d[0]]},
    {"name": "indexical_stmt$string$1", "symbols": [{"literal":":"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "indexical_stmt", "symbols": [{"literal":"~"}, "identifier", "_", "indexical_stmt$string$1", "_", "term"], "postprocess": (d) => ({ tag: "deictic", id: d[1], value: d[5] })},
    {"name": "indexical_list$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}]},
    {"name": "indexical_list$ebnf$1", "symbols": ["indexical_list$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "indexical_list$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "indexical_list", "symbols": ["indexical_stmt", "indexical_list$ebnf$1"], "postprocess": (d) => [d[0]]},
    {"name": "indexical_list", "symbols": ["indexical_stmt", "comma", "indexical_list"], "postprocess": (d) => [d[0], ...d[2]]},
