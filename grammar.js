...
let ParserRules = [
    ...
    {"name": "episode_expr$string$2", "symbols": [{"literal":"b"}, {"literal":"r"}, {"literal":"a"}, {"literal":"n"}, {"literal":"c"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "episode_expr", "symbols": ["episode_expr$string$2", "_", {"literal":"("}, "episode_expr$ebnf$1", "cp"], "postprocess": (d) => [{ tag: "branch", value: d[3].map((d) => d[2]) }]},
